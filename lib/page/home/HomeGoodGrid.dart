import 'package:lixiangyu/page/common/Network.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter_staggered_grid_view/flutter_staggered_grid_view.dart';
import 'HomeGoodItem.dart';
...
class HomeGoodGrid extends StatefulWidget {  
  
  HomeGoodGrid({Key key, this.categoryType}) : super(key: key);

  final String categoryType;

  @override
  State<StatefulWidget> createState() {
    return _HomeGoodGridState();
  }
}

class _HomeGoodGridState extends State<HomeGoodGrid> with AutomaticKeepAliveClientMixin{
  
  int page = 0;
  LoadingState loadingState = LoadingState.nona; 
  bool isPerformingRequest = false;
  List<HomeGoodModel> datas = [];
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverStaggeredGrid.countBuilder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return HomeGoodItem(model: datas[index],);
                      },
                      staggeredTileBuilder: (int index) {
                        return StaggeredTile.count(2, index.isEven ? 3.1 : 3.1);
                      },
                    ),
                  ),
