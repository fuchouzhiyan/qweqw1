...
class _OrderDetailsState extends State<OrderDetails> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    sectionTexts.add(SectionTextModel(position: 0, text: '已接单', progressColor: Colors.green));
    sectionTexts.add(SectionTextModel(position: 1, text: '预约上门', progressColor: Colors.green));
    sectionTexts.add(SectionTextModel(position: 2, text: '任务开始', progressColor: Colors.green));
    sectionTexts.add(SectionTextModel(position: 3, text: '任务完成', progressColor: Colors.green));
    sectionTexts.add(SectionTextModel(position: 4, text: '订单评价', progressColor: Colors.green));
  }
        ...
        body: SingleChildScrollView(
          child: Container(
            ...
            children: <Widget>[
                    ...
                    Container(
                        margin: EdgeInsets.fromLTRB(45, 30, 40, 40),
                        width: 300,
                        child: SeekBar(
                          progresseight: 13,
                          value: 0,
                          ...
                          sectionDecimal: 0,
                          sectionTextColor: Colors.grey,
                          sectionSelectTextColor: Colors.green,
                          sectionTextSize: 16,
                          //hideBubble: false,
                          bubbleRadius: 14,
