...
class NoPayOrderDetails extends StatefulWidget {
  @override
  _NoPayOrderDetailsState createState() => _NoPayOrderDetailsState();
}

class _NoPayOrderDetailsState extends State<NoPayOrderDetails> {
