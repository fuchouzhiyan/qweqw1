...
import 'package:lixiangyu/page/order/no_pay_order_details.dart';

class NoTaking extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => NoTakingState();
}

class NoTakingState extends State<NoTaking> {
  @override
  ...
  Widget _listItem() {
    return InkWell(
      ...
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => NoPayOrderDetails()),
        );
      },
    );
  }
