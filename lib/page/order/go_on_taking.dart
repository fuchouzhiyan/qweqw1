...
import 'package:lixiangyu/page/order/go_on_order_details.dart';
import 'package:lixiangyu/page/order/no_appraise.dart';

class GoOnTaking extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => GoOnTakingState();
}

class GoOnTakingState extends State<GoOnTaking> with TickerProviderStateMixin{
  ...
  Widget _listItem() {
    return InkWell(
      ...
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => GoOnOrderDetails()),
        );
      },
    );
  }
