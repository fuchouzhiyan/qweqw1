...
//接单详情
class XxGoOnOrderDetails extends StatefulWidget {
  @override
  _XxGoOnOrderDetailsState createState() => _XxGoOnOrderDetailsState();
}

class _XxGoOnOrderDetailsState extends State<XxGoOnOrderDetails> with TickerProviderStateMixin {
