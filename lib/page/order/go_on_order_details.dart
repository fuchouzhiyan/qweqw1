...
//接单详情
class GoOnOrderDetails extends StatefulWidget {
  @override
  _GoOnOrderDetailsState createState() => _GoOnOrderDetailsState();
}

class _GoOnOrderDetailsState extends State<GoOnOrderDetails> with TickerProviderStateMixin {
